...
sources:
  ...
  - <repo-name/path/to/test-or-contract>
related:
  - architecture/hld.md
created: "<YYYY-MM-DD>"
updated: "<YYYY-MM-DD>"
...
| --- | --- | --- |
| `Бизнес-возможность` | `наблюдаемый факт \| выведено косвенно \| требует подтверждения` | `<repo-name/path>` |
| `Текущее поведение` | `наблюдаемый факт \| выведено косвенно \| требует подтверждения` | `<repo-name/path>` |
| `Функциональные правила` | `наблюдаемый факт \| выведено косвенно \| требует подтверждения` | `<repo-name/path>` |
| `Нефункциональные характеристики` | `наблюдаемый факт \| выведено косвенно \| требует подтверждения` | `<repo-name/path>` |
| `Основной поток` | `наблюдаемый факт \| выведено косвенно \| требует подтверждения` | `<repo-name/path>` |
