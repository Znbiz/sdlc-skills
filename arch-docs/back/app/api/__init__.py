...
from app.api.rest.git_connections import router as rest_git_connections_router
from app.api.rest.git_ssh import router as rest_git_ssh_router
from app.api.rest.llm_providers import router as rest_llm_providers_router
...
def setup_routers(app: fastapi.FastAPI) -> None:
    ...
    app.include_router(rest_git_connections_router, prefix="/api/rest", tags=["rest"])
    app.include_router(rest_git_ssh_router, prefix="/api/rest", tags=["rest"])
    app.include_router(rest_llm_providers_router, prefix="/api/rest", tags=["rest"])
