...
- На своём уровне: если endpoint/схема/DTO в `architecture/contracts/*` описывает файл из «Удалённые пути» текущего окна — удалить или обновить запись контракта, а не оставлять описание несуществующего API.
