...
- На своём уровне: если client/consumer/producer, описанный в `architecture/integrations-overview.md`, лежал в файле из «Удалённые пути» текущего окна — убрать соответствующую строку из карты интеграций и связь из `landscape.yaml`.
